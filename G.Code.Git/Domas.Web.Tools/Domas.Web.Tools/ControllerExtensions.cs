...
using Domas.Web.Tools.ActionResults;

namespace Domas.Web.Tools
{
    ///<summary>
    ...
    public static class ControllerExtensions
    {
        ...
        public static string GetActionUri<T>(this T controller) where T : Controller
        {
            ...
            var uiCode = string.Format("{0}_{1}_{2}", areaName, controllerName, actionName);
            return uiCode;
        }
    }
}