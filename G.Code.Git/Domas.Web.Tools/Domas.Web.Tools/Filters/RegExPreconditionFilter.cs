...
namespace Domas.Web.Tools.Filters
{
    ...
    /// More info <see href="http://blog.troyd.net/ASPNET+MVC+Controller+Action+Precondition+Filter+V2+Now+Part+Of+Domas.Web.Tools+Project.aspx">here</see>.
	/// </summary>
	/// <example>
	/// <code>
